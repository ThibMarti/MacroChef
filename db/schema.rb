...
ActiveRecord::Schema[8.1].define(version: 2026_07_10_091624) do
  ...
  create_table "chats", force: :cascade do |t|
    ...
    t.index ["preference_id"], name: "index_chats_on_preference_id"
  ...
  create_table "recipe_ingredients", force: :cascade do |t|
    ...
    t.decimal "kcal", precision: 8, scale: 2, default: "0.0", null: false
    t.string "name", null: false
    ...
    t.bigint "recipe_id", null: false
    t.string "unit", default: "serving", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "chats", "preferences"
